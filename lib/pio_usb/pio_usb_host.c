...
// Compatibility stub for TinyUSB >= 3.5
// hcd_pio_usb.c calls this; our v0.5.3 doesn't have it.
// Cleanup already happens via pio_usb_host_close_device() on disconnect.
